  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-md max-w-4xl mx-auto">
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} md={8} className="flex flex-col items-center text-center mb-6 md:mb-0">
            <Avatar
              size={150}
            ...
            <p className="text-xs text-gray-500 mt-1">JPG/PNG/GIF, <br className="md:hidden" /> nhỏ hơn 2MB</p>
